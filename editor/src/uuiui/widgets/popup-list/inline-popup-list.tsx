...
const SingleValue = (props: SingleValueProps<SelectOption>) => {
  return (
    <components.SingleValue {...props}>
      {props.data.icon == null ? null : <Icn {...props.data.icon} />}
      <span style={{ paddingLeft: 2, paddingRight: 2 }}>{props.children}</span>
...
export const InlinePopupList = betterReactMemo<PopupListProps>(
  'InlinePopupList',
  ({
    id,
    options,
    ...
    return (
      <Select
        ...
        styles={{
          container: (base) => ({
            color: UtopiaTheme.color.primary.value,
            display: 'flex',
          }),
          ...
          valueContainer: () => ({
            ...
            color: UtopiaTheme.color.primary.value,
            '&:hover': {
              background: UtopiaTheme.color.primary.shade(10).value,
            },
            '&:active, &:focus-within': {
              background: UtopiaTheme.color.primary.value,
              color: 'white',
            },
          }),
